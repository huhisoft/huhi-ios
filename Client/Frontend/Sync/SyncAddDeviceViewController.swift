...
class SyncAddDeviceViewController: SyncViewController {
    ...
    lazy var copyPasteButton: UIButton = {
        ...
        button.setTitleColor(HuhiUX.HuhiOrange, for: .normal)
    ...
    func setupVisuals() {
        ...
        modeControl.tintColor = HuhiUX.HuhiOrange
        ...
        doneButton.backgroundColor = HuhiUX.HuhiOrange
        ...
        enterWordsButton.setTitleColor(HuhiUX.GreyH, for: .normal)

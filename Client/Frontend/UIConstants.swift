...
public struct UIConstants {
    ...
    // Passcode dot gray
    static let PasscodeDotColor = HuhiUX.GreyG
  
    // Huhi Orange
    static let ControlTintColor = HuhiUX.HuhiOrange
  
    // settings
    static let TableViewHeaderBackgroundColor = HuhiUX.GreyA
    static let TableViewHeaderTextColor = HuhiUX.GreyH
    static let TableViewRowTextColor = HuhiUX.GreyJ
    static let TableViewDisabledRowTextColor = HuhiUX.GreyE
    static let TableViewSeparatorColor = HuhiUX.GreyC

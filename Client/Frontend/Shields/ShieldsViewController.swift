...
class ShieldsViewController: UIViewController, PopoverContentComponent {
    ...
    private func updateHuhiShieldState(shield: HuhiShield, on: Bool, option: Preferences.Option<Bool>?) {
        ...
        Domain.setHuhiShield(forUrl: url, shield: shield, isOn: isOn,
    ...
    private lazy var shieldControlMapping: [(HuhiShield, ToggleView, Preferences.Option<Bool>?)] = [
    ...
    override func viewDidLoad() {
        ...
        shieldControlMapping.forEach { shield, toggle, option in
            toggle.valueToggled = { [unowned self] on in
                ...
                self.updateHuhiShieldState(shield: shield, on: on, option: option)

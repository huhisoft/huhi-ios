...
class FavoritesViewController: UIViewController, Themeable {
    ...
    private let huhiShieldStatsView = HuhiShieldStatsView(frame: CGRect.zero).then {
    ...
    override func viewDidLoad() {
        ...
        var statsViewFrame: CGRect = huhiShieldStatsView.frame
        ...
        huhiShieldStatsView.frame = statsViewFrame
        
        collection.addSubview(huhiShieldStatsView)

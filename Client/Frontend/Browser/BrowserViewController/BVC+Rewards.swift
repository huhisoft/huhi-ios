...
// Since HuhiRewardsUI is a separate framework, we have to implement Popover conformance here.
...
extension BrowserViewController {
    ...
    func showHuhiRewardsPanel() {
        ...
        let huhiRewardsPanel = RewardsPanelController(
            rewards,
        ...
        let popover = PopoverController(contentController: huhiRewardsPanel, contentSizeBehavior: .preferredContentSize)
...
extension BrowserViewController: RewardsUIDelegate {
    func presentHuhiRewardsController(_ controller: UIViewController) {
...
extension Tab {
    func reportPageLoad(to rewards: HuhiRewards) {

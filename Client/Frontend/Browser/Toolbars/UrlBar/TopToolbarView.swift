...
class TopToolbarView: UIView, ToolbarProtocol {
    ...
    fileprivate lazy var cancelButton: UIButton = {
        ...
        cancelButton.setTitleColor(HuhiUX.CancelTextColor, for: .normal)
    ...
    @objc func didClickHuhiShieldsButton() {
        delegate?.topToolbarDidTapHuhiShieldsButton(self)
    }
}
...
extension TopToolbarView: TabLocationViewDelegate {
    ...
    func tabLocationViewDidTapRewardsButton(_ urlBar: TabLocationView) {
        delegate?.topToolbarDidTapHuhiRewardsButton(self)
    }

...
class TabLocationView: UIView {
    ...
    lazy var shieldsButton: ToolbarButton = {
        ...
        button.addTarget(self, action: #selector(didClickHuhiShieldsButton), for: .touchUpInside)
        button.imageView?.contentMode = .center
        button.accessibilityLabel = Strings.Huhi_Panel
    ...
    lazy var rewardsButton: RewardsButton = {
        ...
        button.addTarget(self, action: #selector(didClickHuhiRewardsButton), for: .touchUpInside)
    ...
    @objc func didClickHuhiRewardsButton() {

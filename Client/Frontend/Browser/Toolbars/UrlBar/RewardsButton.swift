...
class RewardsButton: UIButton {
    ...
    private var checkmarkView = UIImageView().then {
        let checkmark = #imageLiteral(resourceName: "huhi_rewards_verified_badge")
        $0.image = checkmark
    ...
    private func updateView() {
        ...
        if isDisabled {
            setImage(#imageLiteral(resourceName: "huhi_rewards_button_disabled"), for: .normal)
            return
        }
        
        setImage(#imageLiteral(resourceName: "huhi_rewards_button_enabled"), for: .normal)

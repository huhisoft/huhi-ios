...
//            $0.barTintColor = HuhiUX.BackgroundColorForSideToolbars
  ...
  fileprivate func configureCell(_ cell: UITableViewCell, atIndexPath indexPath: IndexPath) {
    ...
    func configCell(image: UIImage? = nil, icon: FaviconMO? = nil) {
      ...
      if let image = image {
        ...
        cell.imageView?.layer.borderColor = HuhiUX.faviconBorderColor.cgColor
        cell.imageView?.layer.borderWidth = HuhiUX.faviconBorderWidth

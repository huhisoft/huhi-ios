...
extension OnboardingSearchEnginesViewController {
    ...
    class View: UIView {
        ...
        private let huhiLogo = UIImageView(image: #imageLiteral(resourceName: "browser_lock_popup")).then { logo in
        ...
        init() {
            ...
            mainStackView.snp.makeConstraints {
                $0.top.equalTo(huhiLogo.snp.bottom).offset(30)
        ...
        private func startAnimations() {
            UIView.animate(withDuration: 0.7, animations: huhiLogoAnimation) { _ in
                self.huhiLogoBounceEffect()
        ...
        private func huhiLogoAnimation() {
            // This is how many points until we reach top of the view.
            let logoY = -self.huhiLogo.frame.minY
            ...
            self.huhiLogo.snp.updateConstraints {
                $0.height.equalTo(UX.logoSizeAfterAnimation)
            }
            self.layoutIfNeeded()
        }
        
        private func huhiLogoBounceEffect() {
            POPBasicAnimation(propertyNamed: kPOPLayerTranslationY)?.do {
                ...
                $0.autoreverses = true
                $0.duration = 2
                self.huhiLogo.layer.pop_add($0, forKey: "huhiLogoTranslateY")
            }
        }

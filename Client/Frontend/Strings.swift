...
extension Strings {
    ...
    // Label used as an item in Settings. When touched it will open a dialog to setup advance Huhi account settings.
    public static let SettingsAdvanceAccountSectionName = "Account Settings"

    // Settings.AdvanceAccount.SectionFooter
    // Details for using custom Huhi Account service.
    public static let SettingsAdvanceAccountSectionFooter = "To use a custom Huhi Account and sync servers, specify the root Url of the Huhi Account site. This will download the configuration and setup this device to use the new service. After the new service has been set, you will need to create a new Huhi Account or login with an existing one."
    ...
    public static let SettingsAdvanceAccountUrlUpdatedAlertMessage = "Huhi account service updated. To begin using custom server, please log out and re-login."
    ...
    public static let SettingsAdvanceAccountUrlErrorAlertMessage = "There was an error while attempting to parse the url. Please make sure that it is a valid Huhi Account root url."
...
extension Strings {
    ...
    public static let UnableToOpenURLError = NSLocalizedString("UnableToOpenURLError", bundle: Bundle.shared, value: "Huhi cannot open the page because it has an invalid address.", comment: "The message displayed to a user when they try to open a URL that cannot be handled by Huhi, or any external app.")
...
extension Strings {
    ...
    public static let ScanQRCodePermissionErrorMessage = NSLocalizedString("ScanQRCodePermissionErrorMessage", bundle: Bundle.shared, value: "Please allow Huhi to access your device’s camera in ‘Settings’ -> ‘Privacy’ -> ‘Camera’.", comment: "Text of the prompt user to setup the camera authorization.")

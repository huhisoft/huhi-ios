...
enum ImageCacheEntityType: String {
  case square = "com.huhi.imageFormatPortrait"
  case portrait = "com.huhi.imageFormatSquare"
}

class ImageCache: NSObject, FICImageCacheDelegate {
  static let shared = ImageCache()
  
  fileprivate let ImageFormatFrameDevice = "com.huhi.imageFormatFrameDevice"
  ...
  override init() {
    ...
    bitmapCache = FICImageCache(nameSpace: "com.huhi.images")

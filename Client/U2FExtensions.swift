...
extension Strings {
    ...
    public static let tryAgain = NSLocalizedString("tryAgain", tableName: "HuhiShared", bundle: Bundle.huhiShared, value: ", please try again.", comment: "Suffix for error strings")
    public static let U2FRegistrationError = NSLocalizedString("U2FRegistrationError", tableName: "HuhiShared", bundle: Bundle.huhiShared, value: "Error registering your security key", comment: "Error handling U2F registration.") + tryAgain
    public static let U2FAuthenticationError = NSLocalizedString("U2FAuthenticationError", tableName: "HuhiShared", bundle: Bundle.huhiShared, value: "Error authenticating your security key", comment: "Error handling U2F authentication.") + tryAgain

...
fileprivate extension Preferences {
    ...
    class func migratePreferences(keyPrefix: String) {
        ...
        /// Wrapper around HuhiShared migrate, to automate prefix injection
        ...
        // Shields
        migrate(key: "huhiBlockAdsAndTracking", to: Preferences.Shields.blockAdsAndTracking)
        migrate(key: "huhiHttpsEverywhere", to: Preferences.Shields.httpsEverywhere)
        migrate(key: "huhiSafeBrowsing", to: Preferences.Shields.blockPhishingAndMalware)
        ...
        migrate(key: "huhiAdblockUseRegional", to: Preferences.Shields.useRegionAdBlock)
        ...
        // HuhiShared
        migrateHuhiShared(keyPrefix: keyPrefix)

...
class HistoryTests: CoreDataTestCase {
    ...
    func testAdd() {
        let title = "Huhi"
        let url = URL(string: "https://huhi.com")!
    ...
    func testFrc() {
        ...
        sleep(UInt32(2))
        let secondObject = createAndWait(title: "Second", url: URL(string: "https://huhi.com")!)
    ...
    func testDeleteAll() {
        ...
        createAndWait()
        createAndWait(title: "title", url: URL(string: "https://huhi.com")!)
        XCTAssertEqual(try! DataController.viewContext.count(for: fetchRequest), 2)
    ...
    func testFrecencyQuery() {
        ...
        createAndWait(url: URL(string: "https://huhi.com")!)

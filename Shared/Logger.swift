...
public extension Logger {
    ...
    /// Logger used for things recorded on HuhiRewards framework.
    ...
    static let huhiSyncLogger = RollingFileLogger(filenameRoot: "huhisync", logDirectoryPath: Logger.logFileDirectoryPath())

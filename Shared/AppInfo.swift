...
open class AppInfo {
    ...
    public static var sharedContainerIdentifier: String {
        ...
        if bundleIdentifier == "com.huhi.ios.BrowserBeta" {
            // com.huhi.ios.BrowserBeta is taken and can't be used as an app group.
            bundleIdentifier = "com.huhi.ios.BrowserBeta.unique"
        }
    ...
    public static func keychainAccessGroupWithPrefix(_ prefix: String) -> String {
        var bundleIdentifier = baseBundleIdentifier
        if bundleIdentifier == "com.huhi.ios.FennecEnterprise" {
            ...
            bundleIdentifier = "com.huhi.ios.Fennec.enterprise"
        }

...
class FavoritesViewControllerTests: XCTestCase {
    ...
    func testTopSiteDelegate_ReceivesFullURL() {
        ...
        XCTAssertEqual(delegate.input, HTTPS_HUHI_COM, "The Favorites destination is incorrect.")
    ...
    func testTopSiteDelegate_ReceivesURLWithoutScheme() {
        ...
        XCTAssertEqual(delegate.input, HUHI_COM, "The Favorites destination is incorrect.")

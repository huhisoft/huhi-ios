...
open class HuhiGlobalShieldStats {
    public static let shared = HuhiGlobalShieldStats()
    public static let DidUpdateNotification = "HuhiGlobalShieldStatsDidUpdate"
    ...
    private func postUpdateNotification() {
        NotificationCenter.default.post(name: Notification.Name(rawValue: HuhiGlobalShieldStats.DidUpdateNotification), object: nil)
    }

...
public struct HuhiUX {
    ...
    public static let HuhiOrange = UIColor(rgb: 0xfb542b)
    ...
    public static let HuhiButtonMessageInUrlBarColor = HuhiOrange
    public static let HuhiButtonMessageInUrlBarShowTime = 0.5
    public static let HuhiButtonMessageInUrlBarFadeTime = 0.7
